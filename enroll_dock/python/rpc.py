...
class Service:
    ...
    def insert(self, id, firstname, lastname):
        result = insert(id, firstname, lastname, '081102', 1, 2565)
        result = insert(id, firstname, lastname, '520101', 1, 2565)
        result = insert(id, firstname, lastname, '511100', 1, 2565)
        result = insert(id, firstname, lastname, '517121', 1, 2565)
        return result
